$(document).ready(function () {
  ...
  $('.pet__row__item').click(function (e) {
    ...
    if($(this).hasClass('active')){
      ...
      if(pr__class == "pr__1"){
        parent_class.find('.' + pr__class).delay(600).slideDown();
        parent_class.find('[data-pr="pr__2"]').css({"transform":"translate(-400px,0)","z-index":"1"}).delay(600).fadeOut(0);
        parent_class.find('[data-pr="pr__3"]').css({"transform":"translate(-800px,0)","z-index":"2"}).delay(600).fadeOut(0);
